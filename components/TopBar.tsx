              ...
              {!user ? (
                ...
                >
                  ...
                  {pathname === "/profiledata" ? (
                    <Link
                      href="/profiledata"
                      className="hidden sm:inline-block px-4 py-2 bg-primary-dark text-white rounded-full text-sm font-semibold transition-colors shadow-hover border-2 border-white" >                      App Settings
                    </Link>
                  ) : (
                    <Link
                      href="/profiledata"
                  ...
                  <div
                    ...
                    <button
                      ...
                      <div className="w-8 h-8 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center text-primary dark:text-primary-light">{user.email?.[0].toUpperCase()}</div>
                    </button>
